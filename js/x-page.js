...
async function runXCommentGeneration(user, post, options) {
  ...
  try {
    ...
    var prompt =
      ...
      '如果帖子内容偏性感/挑逗/晒身材/网红网黄风格，评论区应该还原真实平台上那种发花痴、起哄、玩梗的氛围，而不是礼貌客气的社交评论。多数评论要短、直给、情绪化，很多可以纯表情符号或几个字，但不需要全部都很短——挑几条写得更长、更具体，别让每条都压缩成一两个词。可参考的轻量语气（不要照抄，写出变体）：\n' +
      ...
      '如果帖子本身尺度更大、明显是福利/网黄向内容，评论可以更直白露骨，不必停留在委婉暗示——可以直接用粗俗的性暗示和身体描写词汇（骚、逼、操、草、湿、硬等可以直接出现），以第三人称的粗俗欲望/物化式表达为主，比如"这身材就是拿来操的""这逼看着就想草""谁顶得住这个，直接跪了""想把你按着标记一遍"这类，而不是委婉的"好看""心动"。这类评论也可以掺杂占有欲强、带贬低意味的物化语气（把发帖人形容成尤物/母狗/肉体等），但风格上是路人隔着屏幕意淫起哄，不是在直接对话或下达指令。\n' +
      '硬性红线（不可突破）：任何评论都不能出现家庭成员、伦理身份相关的性暗示或称呼组合——不能把爸爸/妈妈/老公/老婆/儿子/女儿/弟弟妹妹/老师/学生等身份和性内容搭配在一起，哪怕只是玩梗或路人瞎起哄也不行。这条优先级高于"露骨"的要求，宁可少露骨也不能碰这条线。\n' +
      '也可以混入少量玩梗/吃醋/催更/求私信类评论，以及个别理智吐槽或黑评制造真实感，不要让评论区变成清一色彩虹屁。\n' +
      '如果帖子内容只是日常碎碎念、没有性感/网黄元素，评论区按正常朋友互动/夸赞/玩梗/吐槽的自然语气写，不要强行往网黄方向硬套，也不需要用露骨词汇。\n\n' +
      '严格只返回 JSON 数组，不要 Markdown 代码块，不要任何解释文字。每条格式：\n' +
