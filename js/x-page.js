...
async function runXCommentGeneration(user, post, options) {
  ...
  try {
    ...
    var prompt =
      ...
      '- camera man really said 📸🔥\n' +
      '- sir this is doing things to me\n' +
      '- the way I just sat up straight\n' +
      '- who let you post this and live\n' +
      '这些例子已经是可以直接使用的粗俗程度，性器官相关的词（骚、逼、操、草、湿、硬等）可以直接出现，不需要再委婉化。\n\n' +
